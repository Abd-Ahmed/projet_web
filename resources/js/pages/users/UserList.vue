...
const deleteUser = () => {
    ...
    .then(() => {
        ...
        toastr.success('Secretary deleted successfully!');
            ...
            <div class="d-flex justify-content-between">
                <div class="d-flex">
                    ...
                    <div v-if="selectedUsers.length > 0">
                        ...
                        <span class="ml-2">Selected {{ selectedUsers.length }} Secretary</span>
                    </div>
                </div>
                <div>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">
                        <span v-if="editing">Edit Secretary</span>
                        <span v-else>Add New Secretary</span>
                    </h5>
    ...
    <div class="modal fade" id="deleteUserModal" data-backdrop="static" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h5>Are you sure you want to delete this Secretary ?</h5>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                    <button @click.prevent="deleteUser" type="button" class="btn btn-primary">Delete Secretary</button>
                </div>
            </div>
        </div>
    </div>
